define(["exports"], function (t) {
  ...
  let L = {
    get(t, e, s) {
      if (t instanceof IDBTransaction) {
        ...
        if ("objectStoreNames" === e) return t.objectStoreNames || D.get(t);
        if ("store" === e)
  ...
  function I(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...e) {
            return t.apply(O(this), e), C(b.get(this));
          }
        : function (...e) {
            return C(t.apply(O(this), e));
          }
      : function (e, ...s) {
          const n = t.call(O(this), e, ...s);
          return D.set(n, e.sort ? e.sort() : [e]), C(n);
        };
  }
  function E(t) {
  ...
  function C(t) {
    ...
    const e = E(t);
    return e !== t && (U.set(t, e), x.set(e, t)), e;
  }
  const O = (t) => x.get(t);
  ...
  L = ((t) =>
    g({}, t, {
      get: (e, s, n) => M(e, s) || t.get(e, s, n),
      has: (e, s) => !!M(e, s) || t.has(e, s),
    }))(L);
  try {
  ...
  class W {
    ...
    async setTimestamp(t, e) {
      const s = {
        ...
        n = (await this.getDb()).transaction(T, "readwrite", {
          durability: "relaxed",
        });
  ...
  class P {
    ...
    async expireEntries() {
      ...
      (this.R = !1), this.v && ((this.v = !1), p(this.expireEntries()));
    }
  ...
  class H {
    constructor(t, e) {
      (this._ = {}),
        ...
        (this.N = [...t.plugins]),
        (this.B = new Map());
      for (const t of this.N) this.B.set(t, {});
  ...
  class $ {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new H(this, { event: e, request: s, params: n }),
        r = this.M(i, s, e);
  ...
  (t.ExpirationPlugin = class {
    ...
    (t.StaleWhileRevalidate = class extends $ {
      constructor(t = {}) {
        super(t),
...
//# sourceMappingURL=workbox-a6408148.js.map
